...
// E2E: Payment Options -> Check -> Custom schedule -> save

test('Kevin: Check custom schedule saved from Payment Options', async ({ page, request }) => {
  ...
  // Select Check + Custom Schedule
  await page.getByRole('heading', { name: 'Check Payment' }).click();
