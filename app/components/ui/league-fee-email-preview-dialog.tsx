        ...
        <div className="space-y-6">
          ...
          {isGenerating ? (
            ...
            <>
              ...
              <div className="bg-orange-50 p-4 rounded-lg">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
                  <div className="flex items-center gap-2">
                    ...
                    <Badge variant="outline" className="text-xs">Real Link</Badge>
                  </div>
                  <div className="flex items-center gap-2">
              ...
              {/* Professional RA1 Branding Preview */}
              <div className="bg-gray-50 p-4 rounded-lg border-l-4 border-blue-500">
                <div className="text-sm text-gray-600 mb-2">Email will include professional RA1 signature:</div>
                <div className="text-sm font-medium text-gray-800">
                  Kevin Houston<br />
                  Rise as One Director<br />
